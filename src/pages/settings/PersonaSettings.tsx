        ...
        <CardContent className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Qual o objetivo principal do atendimento?"
              className="min-h-[100px] resize-y"
            />
          </div>
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Forneça detalhes sobre seus produtos, preços, FAQs..."
          ...
          {settings.welcome_message_enabled && (
            <div className="space-y-2 animate-in fade-in slide-in-from-top-2 duration-300">
              ...
              <Textarea
                ...
                placeholder="Olá! Muito obrigado pelo seu contato. Como posso ajudar?"
